...
:latitude => 50.4030555555556,
:longitude => 14.1319444444444
})
Town.create({
:name => "Jihlava",
:department => "Jihlava",
:wikiref => "http://cs.wikipedia.org/wiki/Jihlava",
:latitude => 49.3963888888889,
:longitude => 15.5902777777778
})
Town.create({
:name => "Pelhřimov",
:department => "Pelhřimov",
:wikiref => "http://cs.wikipedia.org/wiki/Pelh%C5%99imov",
:latitude => 49.4308333333333,
:longitude => 15.2230555555556
})
Town.create({
...
:latitude => 50.0455555555556,
:longitude => 15.3569444444444
})
Town.create({
:name => "Liběchov",
:department => "Mělník",
:wikiref => "http://cs.wikipedia.org/wiki/Lib%C4%9Bchov",
:latitude => 50.4077777777778,
:longitude => 14.4469444444444
})
Town.create({
:name => "Broumov",
:department => "Náchod",
:wikiref => "http://cs.wikipedia.org/wiki/Broumov",
:latitude => 50.5883333333333,
:longitude => 16.33
})
Town.create({
:name => "Zliv",
...
:latitude => 49.0661111111111,
:longitude => 14.3661111111111
})
Town.create({
...
:latitude => 49.2652777777778,
:longitude => 14.9211111111111
})
Town.create({
...
:latitude => 50.2402777777778,
:longitude => 15.4919444444444
})
Town.create({
:name => "Lázně Bohdaneč",
:department => "Pardubice",
:wikiref => "http://cs.wikipedia.org/wiki/L%C3%A1zn%C4%9B_Bohdane%C4%8D",
:latitude => 50.0744444444444,
:longitude => 15.6788888888889
})
Town.create({
:name => "Sobotka",
:department => "Jičín",
...
:longitude => 14.0783333333333
})
Town.create({
:name => "Kostelec nad Labem",
:department => "Mělník",
:wikiref => "http://cs.wikipedia.org/wiki/Kostelec_nad_Labem",
:latitude => 50.2266666666667,
:longitude => 14.5863888888889
})
Town.create({
...
:latitude => 50.1697222222222,
:longitude => 16.4730555555556
})
Town.create({
:name => "Plasy",
:department => "Plzeň-sever",
:wikiref => "http://cs.wikipedia.org/wiki/Plasy",
:latitude => 49.9347222222222,
:longitude => 13.3930555555556
})
Town.create({
:name => "Březnice",
:department => "Příbram",
:wikiref => "http://cs.wikipedia.org/wiki/B%C5%99eznice",
:latitude => 49.5586111111111,
:longitude => 13.9541666666667
})
Town.create({
:name => "Oloví",
:department => "Sokolov",
:wikiref => "http://cs.wikipedia.org/wiki/Olov%C3%AD",
:latitude => 50.2455555555556,
:longitude => 12.5508333333333
})
Town.create({
:name => "Vodňany",
:department => "Strakonice",
:wikiref => "http://cs.wikipedia.org/wiki/Vod%C5%88any",
:latitude => 49.1477777777778,
:longitude => 14.1755555555556
})
Town.create({
:name => "Kosmonosy",
...
:latitude => 49.9180555555556,
:longitude => 15.8158333333333
})
Town.create({
:name => "Sedlec-Prčice",
:department => "Příbram",
...
:latitude => 50.03,
:longitude => 15.9130555555556
})
Town.create({
:name => "Jablonec nad Nisou",
:department => "Jablonec nad Nisou",
:wikiref => "http://cs.wikipedia.org/wiki/Jablonec_nad_Nisou",
:latitude => 50.7241666666667,
:longitude => 15.1711111111111
})
Town.create({
:name => "Vamberk",
:department => "Rychnov nad Kněžnou",
:wikiref => "http://cs.wikipedia.org/wiki/Vamberk",
:latitude => 50.1177777777778,
:longitude => 16.29
})
Town.create({
:name => "Bechyně",
...
:latitude => 49.2952777777778,
:longitude => 14.4686111111111
})
Town.create({
:name => "Letohrad",
...
:latitude => 49.0522222222222,
:longitude => 13.7741666666667
})
Town.create({
:name => "Nový Knín",
:department => "Příbram",
...
:latitude => 50.95,
:longitude => 14.5583333333333
})
Town.create({
:name => "Domažlice",
:department => "Domažlice",
:wikiref => "http://cs.wikipedia.org/wiki/Doma%C5%BElice",
:latitude => 49.4405555555556,
:longitude => 12.9272222222222
})
Town.create({
:name => "Zbiroh",
:department => "Rokycany",
:wikiref => "http://cs.wikipedia.org/wiki/Zbiroh",
:latitude => 49.8588888888889,
:longitude => 13.7688888888889
})
Town.create({
:name => "Horní Jelení",
:department => "Pardubice",
:wikiref => "http://cs.wikipedia.org/wiki/Horn%C3%AD_Jelen%C3%AD",
:latitude => 50.0488888888889,
:longitude => 16.0863888888889
})
Town.create({
:name => "Přebuz",
:department => "Sokolov",
:wikiref => "http://cs.wikipedia.org/wiki/P%C5%99ebuz",
:latitude => 50.3658333333333,
:longitude => 12.6202777777778
})
Town.create({
:name => "Přibyslav",
:department => "Havlíčkův Brod",
:wikiref => "http://cs.wikipedia.org/wiki/P%C5%99ibyslav",
:latitude => 49.5772222222222,
:longitude => 15.7380555555556
})
Town.create({
:name => "Proseč",
:department => "Chrudim",
...
:latitude => 49.8025,
:longitude => 16.1191666666667
})
Town.create({
:name => "Vroutek",
:department => "Louny",
:wikiref => "http://cs.wikipedia.org/wiki/Vroutek",
:latitude => 50.1791666666667,
:longitude => 13.3797222222222
})
Town.create({
:name => "Sezimovo Ústí",
:department => "Tábor",
:wikiref => "http://cs.wikipedia.org/wiki/Sezimovo_%C3%9Ast%C3%AD",
:latitude => 49.3852777777778,
:longitude => 14.6844444444444
})
Town.create({
:name => "Jirkov",
:department => "Chomutov",
:wikiref => "http://cs.wikipedia.org/wiki/Jirkov",
:latitude => 50.5002777777778,
:longitude => 13.4419444444444
})
Town.create({
:name => "Cheb",
:department => "Cheb",
:wikiref => "http://cs.wikipedia.org/wiki/Cheb",
:latitude => 50.0794444444444,
:longitude => 12.3705555555556
})
Town.create({
:name => "Kouřim",
:department => "Kolín",
:wikiref => "http://cs.wikipedia.org/wiki/Kou%C5%99im",
:latitude => 50.0027777777778,
:longitude => 14.9744444444444
})
Town.create({
:name => "Osečná",
:department => "Liberec",
...
:latitude => 49.7225,
:longitude => 14.6672222222222
})
Town.create({
:name => "Jaroměř",
:department => "Náchod",
:wikiref => "http://cs.wikipedia.org/wiki/Jarom%C4%9B%C5%99",
:latitude => 50.3502777777778,
:longitude => 15.9183333333333
})
Town.create({
...
:latitude => 49.8930555555556,
:longitude => 13.3830555555556
})
Town.create({
:name => "Mašťov",
:department => "Chomutov",
:wikiref => "http://cs.wikipedia.org/wiki/Ma%C5%A1%C5%A5ov",
:latitude => 50.2652777777778,
:longitude => 13.2763888888889
})
Town.create({
:name => "Veltrusy",
:department => "Mělník",
:wikiref => "http://cs.wikipedia.org/wiki/Veltrusy",
:latitude => 50.2711111111111,
:longitude => 14.3280555555556
})
Town.create({
:name => "Červená Řečice",
:department => "Pelhřimov",
:wikiref => "http://cs.wikipedia.org/wiki/%C4%8Cerven%C3%A1_%C5%98e%C4%8Dice",
:latitude => 49.5080555555556,
:longitude => 15.1697222222222
})
Town.create({
...
:latitude => 49.3211111111111,
:longitude => 13.7013888888889
})
Town.create({
:name => "Neveklov",
:department => "Benešov",
...
:latitude => 49.7530555555556,
:longitude => 14.5358333333333
})
Town.create({
:name => "Netolice",
:department => "Prachatice",
:wikiref => "http://cs.wikipedia.org/wiki/Netolice",
:latitude => 49.0491666666667,
:longitude => 14.1963888888889
})
Town.create({
:name => "Milovice",
:department => "Nymburk",
:wikiref => "http://cs.wikipedia.org/wiki/Milovice",
:latitude => 50.2288888888889,
:longitude => 14.8905555555556
})
Town.create({
:name => "Blšany",
:department => "Louny",
:wikiref => "http://cs.wikipedia.org/wiki/Bl%C5%A1any",
:latitude => 50.2222222222222,
:longitude => 13.4763888888889
})
Town.create({
:name => "Žatec",
:department => "Louny",
...
:latitude => 49.9941666666667,
:longitude => 14.8555555555556
})
Town.create({
:name => "Mladá Boleslav",
:department => "Mladá Boleslav",
...
:latitude => 50.1533333333333,
:longitude => 16.0786111111111
})
Town.create({
:name => "Hejnice",
:department => "Liberec",
:wikiref => "http://cs.wikipedia.org/wiki/Hejnice",
:latitude => 50.8772222222222,
:longitude => 15.1983333333333
})
Town.create({
:name => "Toužim",
:department => "Karlovy Vary",
:wikiref => "http://cs.wikipedia.org/wiki/Tou%C5%BEim",
:latitude => 50.0594444444444,
:longitude => 12.985
})
Town.create({
:name => "Dobrovice",
...
:latitude => 50.3663888888889,
:longitude => 14.9647222222222
})
Town.create({
:name => "Mirotice",
:department => "Písek",
:wikiref => "http://cs.wikipedia.org/wiki/Mirotice",
:latitude => 49.4288888888889,
:longitude => 14.0369444444444
})
Town.create({
:name => "Libáň",
:department => "Jičín",
:wikiref => "http://cs.wikipedia.org/wiki/Lib%C3%A1%C5%88",
:latitude => 50.3752777777778,
:longitude => 15.2180555555556
})
Town.create({
:name => "Kraslice (okres Sokolov)",
:department => "Sokolov",
:wikiref => "http://cs.wikipedia.org/wiki/Kraslice_(okres_Sokolov)",
:latitude => 50.3291666666667,
:longitude => 12.5086111111111
})
Town.create({
:name => "Lanškroun",
:department => "Ústí nad Orlicí",
:wikiref => "http://cs.wikipedia.org/wiki/Lan%C5%A1kroun",
:latitude => 49.9130555555556,
:longitude => 16.61
})
Town.create({
:name => "Městec Králové",
...
:latitude => 50.2063888888889,
:longitude => 15.2927777777778
})
Town.create({
:name => "Kadaň",
:department => "Chomutov",
:wikiref => "http://cs.wikipedia.org/wiki/Kada%C5%88",
:latitude => 50.3761111111111,
:longitude => 13.2713888888889
})
Town.create({
:name => "Kralovice",
:department => "Plzeň-sever",
...
:latitude => 49.9916666666667,
:longitude => 13.2330555555556
})
Town.create({
:name => "Velešín",
:department => "Český Krumlov",
:wikiref => "http://cs.wikipedia.org/wiki/Vele%C5%A1%C3%ADn",
:latitude => 48.8294444444444,
:longitude => 14.4625
})
Town.create({
:name => "Trutnov",
...
:latitude => 50.6844444444444,
:longitude => 15.1488888888889
})
Town.create({
:name => "Mělník",
:department => "Mělník",
:wikiref => "http://cs.wikipedia.org/wiki/M%C4%9Bln%C3%ADk",
:latitude => 50.3519444444444,
:longitude => 14.475
})
Town.create({
:name => "Třemošná",
...
:latitude => 49.8161111111111,
:longitude => 13.3944444444444
})
Town.create({
:name => "Lysá nad Labem",
:department => "Nymburk",
...
:latitude => 50.2,
:longitude => 14.8333333333333
})
Town.create({
:name => "Žlutice",
:department => "Karlovy Vary",
:wikiref => "http://cs.wikipedia.org/wiki/%C5%BDlutice",
:latitude => 50.0916666666667,
:longitude => 13.1625
})
Town.create({
...
:latitude => 50.1533333333333,
:longitude => 13.8991666666667
})
Town.create({
:name => "Železný Brod",
:department => "Jablonec nad Nisou",
:wikiref => "http://cs.wikipedia.org/wiki/%C5%BDelezn%C3%BD_Brod",
:latitude => 50.6422222222222,
:longitude => 15.2538888888889
})
Town.create({
:name => "Vysoké Mýto",
:department => "Ústí nad Orlicí",
:wikiref => "http://cs.wikipedia.org/wiki/Vysok%C3%A9_M%C3%BDto",
:latitude => 49.9486111111111,
:longitude => 16.1530555555556
})
Town.create({
...
:latitude => 50.535,
:longitude => 15.2597222222222
})
Town.create({
:name => "Horšovský Týn",
:department => "Domažlice",
:wikiref => "http://cs.wikipedia.org/wiki/Hor%C5%A1ovsk%C3%BD_T%C3%BDn",
:latitude => 49.5388888888889,
:longitude => 12.9277777777778
})
Town.create({
:name => "Milevsko",
:department => "Písek",
:wikiref => "http://cs.wikipedia.org/wiki/Milevsko",
:latitude => 49.4502777777778,
:longitude => 14.3594444444444
})
Town.create({
:name => "Chrudim",
:department => "Chrudim",
:wikiref => "http://cs.wikipedia.org/wiki/Chrudim",
:latitude => 49.9511111111111,
:longitude => 15.7955555555556
})
Town.create({
:name => "Rabí",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/Rab%C3%AD",
:latitude => 49.2838888888889,
:longitude => 13.6244444444444
})
Town.create({
:name => "České Velenice",
:department => "Jindřichův Hradec",
:wikiref => "http://cs.wikipedia.org/wiki/%C4%8Cesk%C3%A9_Velenice",
:latitude => 48.7683333333333,
:longitude => 14.9636111111111
})
Town.create({
:name => "Polná",
:department => "Jihlava",
:wikiref => "http://cs.wikipedia.org/wiki/Poln%C3%A1",
:latitude => 49.4886111111111,
:longitude => 15.7161111111111
})
Town.create({
:name => "Desná",
:department => "Jablonec nad Nisou",
...
:latitude => 50.2319444444444,
:longitude => 14.4108333333333
})
Town.create({
:name => "Kladno",
:department => "Kladno",
:wikiref => "http://cs.wikipedia.org/wiki/Kladno",
:latitude => 50.1472222222222,
:longitude => 14.1027777777778
})
Town.create({
:name => "Nové Sedlo",
:department => "Sokolov",
:wikiref => "http://cs.wikipedia.org/wiki/Nov%C3%A9_Sedlo",
:latitude => 50.2086111111111,
:longitude => 12.7422222222222
})
Town.create({
:name => "Trhové Sviny",
:department => "České Budějovice",
:wikiref => "http://cs.wikipedia.org/wiki/Trhov%C3%A9_Sviny",
:latitude => 48.8405555555556,
:longitude => 14.6375
})
Town.create({
...
:latitude => 50.3572222222222,
:longitude => 13.7969444444444
})
Town.create({
:name => "Černošín",
:department => "Tachov",
:wikiref => "http://cs.wikipedia.org/wiki/%C4%8Cerno%C5%A1%C3%ADn",
:latitude => 49.8188888888889,
:longitude => 12.8822222222222
})
Town.create({
:name => "Litvínov",
:department => "Most",
...
:latitude => 49.7438888888889,
:longitude => 15.0961111111111
})
Town.create({
:name => "Chrast",
:department => "Chrudim",
:wikiref => "http://cs.wikipedia.org/wiki/Chrast",
:latitude => 49.9016666666667,
:longitude => 15.9322222222222
})
Town.create({
:name => "Zdice",
:department => "Beroun",
:wikiref => "http://cs.wikipedia.org/wiki/Zdice",
:latitude => 49.9138888888889,
:longitude => 13.9758333333333
})
Town.create({
:name => "Opočno",
:department => "Rychnov nad Kněžnou",
:wikiref => "http://cs.wikipedia.org/wiki/Opo%C4%8Dno",
:latitude => 50.2697222222222,
:longitude => 16.1105555555556
})
Town.create({
:name => "Krásná Lípa",
:department => "Děčín",
:wikiref => "http://cs.wikipedia.org/wiki/Kr%C3%A1sn%C3%A1_L%C3%ADpa",
:latitude => 50.9133333333333,
:longitude => 14.5088888888889
})
Town.create({
:name => "Lovosice",
:department => "Litoměřice",
...
:latitude => 50.8527777777778,
:longitude => 14.8444444444444
})
Town.create({
:name => "Chýnov",
:department => "Tábor",
:wikiref => "http://cs.wikipedia.org/wiki/Ch%C3%BDnov",
:latitude => 49.4061111111111,
:longitude => 14.8105555555556
})
Town.create({
:name => "Hoštka",
:department => "Litoměřice",
:wikiref => "http://cs.wikipedia.org/wiki/Ho%C5%A1tka",
:latitude => 50.4869444444444,
:longitude => 14.3336111111111
})
Town.create({
...
:latitude => 50.4897222222222,
:longitude => 15.5136111111111
})
Town.create({
:name => "Železnice (okres Jičín)",
:department => "Jičín",
:wikiref => "http://cs.wikipedia.org/wiki/%C5%BDeleznice_(okres_Ji%C4%8D%C3%ADn)",
:latitude => 50.4730555555556,
:longitude => 15.3841666666667
})
Town.create({
...
:latitude => 49.9144444444444,
:longitude => 14.2358333333333
})
Town.create({
:name => "Postoloprty",
:department => "Louny",
:wikiref => "http://cs.wikipedia.org/wiki/Postoloprty",
:latitude => 50.3605555555556,
:longitude => 13.6958333333333
})
Town.create({
:name => "Slaný",
:department => "Kladno",
:wikiref => "http://cs.wikipedia.org/wiki/Slan%C3%BD",
:latitude => 50.2305555555556,
:longitude => 14.0813888888889
})
Town.create({
:name => "Hostouň (okres Domažlice)",
:department => "Domažlice",
:wikiref => "http://cs.wikipedia.org/wiki/Hostou%C5%88_(okres_Doma%C5%BElice)",
:latitude => 49.5605555555556,
:longitude => 12.7708333333333
})
Town.create({
:name => "Dubá",
:department => "Česká Lípa",
:wikiref => "http://cs.wikipedia.org/wiki/Dub%C3%A1",
:latitude => 50.5391666666667,
:longitude => 14.5427777777778
})
Town.create({
:name => "Teplice",
:department => "Teplice",
...
:latitude => 50.4772222222222,
:longitude => 16.1833333333333
})
Town.create({
:name => "Mýto",
:department => "Rokycany",
:wikiref => "http://cs.wikipedia.org/wiki/M%C3%BDto",
:latitude => 49.7891666666667,
:longitude => 13.735
})
Town.create({
:name => "Horní Bříza",
...
:latitude => 49.8441666666667,
:longitude => 13.3633333333333
})
Town.create({
:name => "Jablonec nad Jizerou",
:department => "Semily",
:wikiref => "http://cs.wikipedia.org/wiki/Jablonec_nad_Jizerou",
:latitude => 50.7066666666667,
:longitude => 15.4344444444444
})
Town.create({
:name => "Jiříkov",
:department => "Děčín",
:wikiref => "http://cs.wikipedia.org/wiki/Ji%C5%99%C3%ADkov",
:latitude => 50.9944444444444,
:longitude => 14.5708333333333
})
Town.create({
:name => "Nýřany",
:department => "Plzeň-sever",
:wikiref => "http://cs.wikipedia.org/wiki/N%C3%BD%C5%99any",
:latitude => 49.7136111111111,
:longitude => 13.2047222222222
})
Town.create({
:name => "Třeboň",
:department => "Jindřichův Hradec",
:wikiref => "http://cs.wikipedia.org/wiki/T%C5%99ebo%C5%88",
:latitude => 49.0038888888889,
:longitude => 14.7708333333333
})
Town.create({
:name => "Luže",
:department => "Chrudim",
...
:latitude => 50.165,
:longitude => 13.9763888888889
})
Town.create({
:name => "Smečno",
:department => "Kladno",
:wikiref => "http://cs.wikipedia.org/wiki/Sme%C4%8Dno",
:latitude => 50.1880555555556,
:longitude => 14.0419444444444
})
Town.create({
:name => "Rejštejn",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/Rej%C5%A1tejn",
:latitude => 49.1352777777778,
:longitude => 13.5119444444444
})
Town.create({
...
:latitude => 50.7475,
:longitude => 15.2191666666667
})
Town.create({
:name => "Lázně Bělohrad",
:department => "Jičín",
:wikiref => "http://cs.wikipedia.org/wiki/L%C3%A1zn%C4%9B_B%C4%9Blohrad",
:latitude => 50.4288888888889,
:longitude => 15.5827777777778
})
Town.create({
...
:latitude => 50.3438888888889,
:longitude => 16.1519444444444
})
Town.create({
:name => "Ledvice",
:department => "Teplice",
...
:latitude => 50.1830555555556,
:longitude => 12.5519444444444
})
Town.create({
:name => "Ralsko (město)",
:department => "Česká Lípa",
...
:latitude => 49.3725,
:longitude => 14.9630555555556
})
Town.create({
:name => "Dubí",
:department => "Teplice",
:wikiref => "http://cs.wikipedia.org/wiki/Dub%C3%AD",
:latitude => 50.6788888888889,
:longitude => 13.7908333333333
})
Town.create({
:name => "Kutná Hora",
:department => "Kutná Hora",
...
:latitude => 49.8852777777778,
:longitude => 15.5308333333333
})
Town.create({
:name => "Dobřany",
:department => "Plzeň-jih",
...
:longitude => 15.0333333333333
})
Town.create({
:name => "Beroun",
:department => "Beroun",
:wikiref => "http://cs.wikipedia.org/wiki/Beroun",
:latitude => 49.9641666666667,
:longitude => 14.0738888888889
})
Town.create({
:name => "Boží Dar",
:department => "Karlovy Vary",
:wikiref => "http://cs.wikipedia.org/wiki/Bo%C5%BE%C3%AD_Dar",
:latitude => 50.4097222222222,
:longitude => 12.9244444444444
})
Town.create({
:name => "Klatovy",
:department => "Klatovy",
...
:latitude => 49.3963888888889,
:longitude => 13.2969444444444
})
Town.create({
:name => "Měčín",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/M%C4%9B%C4%8D%C3%ADn",
:latitude => 49.4838888888889,
:longitude => 13.4094444444444
})
Town.create({
:name => "Písek (město)",
:department => "Písek",
:wikiref => "http://cs.wikipedia.org/wiki/P%C3%ADsek_(m%C4%9Bsto)",
:latitude => 49.3088888888889,
:longitude => 14.1477777777778
})
Town.create({
:name => "Sedlčany",
:department => "Příbram",
:wikiref => "http://cs.wikipedia.org/wiki/Sedl%C4%8Dany",
:latitude => 49.6583333333333,
:longitude => 14.4255555555556
})
Town.create({
:name => "Příbram",
:department => "Příbram",
:wikiref => "http://cs.wikipedia.org/wiki/P%C5%99%C3%ADbram",
:latitude => 49.6883333333333,
:longitude => 14.0094444444444
})
Town.create({
:name => "Vrchlabí",
:department => "Trutnov",
:wikiref => "http://cs.wikipedia.org/wiki/Vrchlab%C3%AD",
:latitude => 50.6277777777778,
:longitude => 15.6102777777778
})
Town.create({
:name => "Štětí",
:department => "Litoměřice",
:wikiref => "http://cs.wikipedia.org/wiki/%C5%A0t%C4%9Bt%C3%AD",
:latitude => 50.4533333333333,
:longitude => 14.3763888888889
})
Town.create({
:name => "Přimda",
:department => "Tachov",
...
:latitude => 48.79,
:longitude => 14.7786111111111
})
Town.create({
:name => "Jičín",
:department => "Jičín",
:wikiref => "http://cs.wikipedia.org/wiki/Ji%C4%8D%C3%ADn",
:latitude => 50.4369444444444,
:longitude => 15.3516666666667
})
Town.create({
:name => "Nalžovské Hory",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/Nal%C5%BEovsk%C3%A9_Hory",
:latitude => 49.3361111111111,
:longitude => 13.5452777777778
})
Town.create({
:name => "Varnsdorf",
:department => "Děčín",
...
:longitude => 15.1666666666667
})
Town.create({
:name => "Strmilov",
:department => "Jindřichův Hradec",
:wikiref => "http://cs.wikipedia.org/wiki/Strmilov",
:latitude => 49.1588888888889,
:longitude => 15.2008333333333
})
Town.create({
:name => "Poběžovice",
:department => "Domažlice",
:wikiref => "http://cs.wikipedia.org/wiki/Pob%C4%9B%C5%BEovice",
:latitude => 49.5111111111111,
:longitude => 12.8022222222222
})
Town.create({
:name => "Stárkov",
:department => "Náchod",
:wikiref => "http://cs.wikipedia.org/wiki/St%C3%A1rkov",
:latitude => 50.5316666666667,
:longitude => 16.15
})
Town.create({
:name => "Kasejovice",
...
:latitude => 50.6997222222222,
:longitude => 14.8038888888889
})
Town.create({
:name => "Starý Plzenec",
...
:latitude => 50.0797222222222,
:longitude => 14.1208333333333
})
Town.create({
:name => "Strážov",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/Str%C3%A1%C5%BEov",
:latitude => 49.3011111111111,
:longitude => 13.2477777777778
})
Town.create({
:name => "Lom (okres Most)",
:department => "Most",
:wikiref => "http://cs.wikipedia.org/wiki/Lom_(okres_Most)",
:latitude => 50.6005555555556,
:longitude => 13.6561111111111
})
Town.create({
:name => "Benátky nad Jizerou",
:department => "Mladá Boleslav",
:wikiref => "http://cs.wikipedia.org/wiki/Ben%C3%A1tky_nad_Jizerou",
:latitude => 50.2894444444444,
:longitude => 14.8311111111111
})
Town.create({
:name => "Krupka",
:department => "Teplice",
:wikiref => "http://cs.wikipedia.org/wiki/Krupka",
:latitude => 50.6819444444444,
:longitude => 13.8613888888889
})
Town.create({
:name => "Karlovy Vary",
:department => "Karlovy Vary",
:wikiref => "http://cs.wikipedia.org/wiki/Karlovy_Vary",
:latitude => 50.2333333333333,
:longitude => 12.8666666666667
})
Town.create({
:name => "Nýrsko",
:department => "Klatovy",
:wikiref => "http://cs.wikipedia.org/wiki/N%C3%BDrsko",
:latitude => 49.2922222222222,
:longitude => 13.1405555555556
})
Town.create({
:name => "Neratovice",
:department => "Mělník",
...
:latitude => 50.1202777777778,
:longitude => 12.3516666666667
})
Town.create({
:name => "Polička",
:department => "Svitavy",
...
:latitude => 49.2555555555556,
:longitude => 15.1913888888889
})
Town.create({
:name => "Mšeno",
:department => "Mělník",
...
:latitude => 50.0341666666667,
:longitude => 15.4166666666667
})
Town.create({
:name => "Žandov",
:department => "Česká Lípa",
...
:latitude => 50.5933333333333,
:longitude => 14.3486111111111
})
Town.create({
:name => "Bečov nad Teplou",
:department => "Karlovy Vary",
:wikiref => "http://cs.wikipedia.org/wiki/Be%C4%8Dov_nad_Teplou",
:latitude => 50.0847222222222,
:longitude => 12.8394444444444
})
Town.create({
:name => "Meziboří",
:department => "Most",
...
:latitude => 50.6333333333333,
:longitude => 15.8141666666667
})
Town.create({
:name => "Hranice (okres Cheb)",
:department => "Cheb",
:wikiref => "http://cs.wikipedia.org/wiki/Hranice_(okres_Cheb)",
:latitude => 50.3047222222222,
:longitude => 12.1758333333333
})
Town.create({
...
:latitude => 49.0844444444444,
:longitude => 14.7172222222222
})
Town.create({
:name => "Chodov (okres Sokolov)",
:department => "Sokolov",
:wikiref => "http://cs.wikipedia.org/wiki/Chodov_(okres_Sokolov)",
:latitude => 50.2391666666667,
:longitude => 12.7486111111111
})
Town.create({
:name => "Rakovník",
:department => "Rakovník",
:wikiref => "http://cs.wikipedia.org/wiki/Rakovn%C3%ADk",
:latitude => 50.1033333333333,
:longitude => 13.7297222222222
})
Town.create({
:name => "Horní Jiřetín",
:department => "Most",
...
:latitude => 49.5933333333333,
:longitude => 12.7133333333333
})
Town.create({
:name => "Pec pod Sněžkou",
:department => "Trutnov",
:wikiref => "http://cs.wikipedia.org/wiki/Pec_pod_Sn%C4%9B%C5%BEkou",
:latitude => 50.6936111111111,
:longitude => 15.7333333333333
})
Town.create({
...
:latitude => 50.4330555555556,
:longitude => 15.8122222222222
})
Town.create({
:name => "Kdyně",
:department => "Domažlice",
:wikiref => "http://cs.wikipedia.org/wiki/Kdyn%C4%9B",
:latitude => 49.3947222222222,
:longitude => 13.0413888888889
})
Town.create({
:name => "Teplá",
:department => "Cheb",
:wikiref => "http://cs.wikipedia.org/wiki/Tepl%C3%A1",
:latitude => 49.9819444444444,
:longitude => 12.8625
})
Town.create({
...
:latitude => 50.1227777777778,
:longitude => 16.2113888888889
})
Town.create({
:name => "Poděbrady",
:department => "Nymburk",
...
:latitude => 49.5930555555556,
:longitude => 13.1072222222222
})
Town.create({
:name => "Benešov",
:department => "Benešov",
:wikiref => "http://cs.wikipedia.org/wiki/Bene%C5%A1ov",
:latitude => 49.7827777777778,
:longitude => 14.6886111111111
})
Town.create({
:name => "Kožlany",
:department => "Plzeň-sever",
:wikiref => "http://cs.wikipedia.org/wiki/Ko%C5%BElany",
:latitude => 49.9930555555556,
:longitude => 13.5361111111111
})
Town.create({
:name => "Jílové u Prahy",
:department => "Praha-západ",
...
:latitude => 49.895,
:longitude => 14.4933333333333
})
Town.create({
:name => "Nechanice",
:department => "Hradec Králové",
:wikiref => "http://cs.wikipedia.org/wiki/Nechanice",
:latitude => 50.2383333333333,
:longitude => 15.6308333333333
})
Town.create({
:name => "Mirošov",
:department => "Rokycany",
:wikiref => "http://cs.wikipedia.org/wiki/Miro%C5%A1ov",
:latitude => 49.6880555555556,
:longitude => 13.6583333333333
})
Town.create({
:name => "Planá",
:department => "Tachov",
:wikiref => "http://cs.wikipedia.org/wiki/Plan%C3%A1",
:latitude => 49.8672222222222,
:longitude => 12.7416666666667
})
